...
void app_main(void)
{
    ...
    if (timeinfo.tm_year < (2016 - 1900)) {
        ...
        // Only to demonstrate a work of adjusting method!
        {
            ...
            int64_t cpu_time = (int64_t)tv_now.tv_sec * 1000000L + (int64_t)tv_now.tv_usec; // this is one MICROSECOND resolution
    ...
    tzset();
    localtime_r(&now, &timeinfo); // this is one second resolution
    strftime(strftime_buf, sizeof(strftime_buf), "%c", &timeinfo);
